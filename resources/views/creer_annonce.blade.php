                ...
                <div class="col-12">
                    ...
                    <form method="POST" action="{{ route('annonce.store') }}">
                        ...
                        <div class="modif-input d-flex flex-column w-50 mx-auto">
                            ...
                            <input type="text" id="domaine" name="domaine" required maxlength="5" max="5">
                            ...
                            <textarea id="description_courte" name="description_courte" rows="3" cols="33" placeholder="Un petite résumé de votre recherche"
                                ></textarea>

                            <label class="mt-3" for="description_longue">Description longue:</label>
                            <textarea id="description_longue" name="description_longue" rows="8" cols="33" placeholder="Une description de votre entreprise et de ce que vous rechercher"
                                ></textarea>
