...
@section('content')
    <html>
<h1>ETAPE 222222222222222222222222222222222222222222</h1>
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-6 modif-input">
                        <div class="row">
                            ...
                            <input type="text" id="email" name="email" required maxlength="30" class="mb-5">
                            @error('email')
                        ...
                        <div class="row">
                            ...
                            <input type="text" id="prenom" name="prenom" required maxlength="30" class="mb-5">
                            @error('prenom')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row">
                            ...
                            <input type="text" id="telephone" name="name" required maxlength="30" class="mb-5">
                            @error('telephone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row">
                            ...
                            <input type="date" id="age" name="age" required maxlength="30">
                            @error('age')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-6 modif-input">
                        ...
                        <div class="row ms-3">
                            ...
                            <input type="text" id="mot_de_passe" name="mot_de_passe" required maxlength="30"
                                class="mb-5">
                            @error('mot_de_passe')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
